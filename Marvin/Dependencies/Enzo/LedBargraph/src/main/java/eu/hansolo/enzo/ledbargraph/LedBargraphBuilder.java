...
public class LedBargraphBuilder<B extends LedBargraphBuilder<B>> {
    ...
    public final B ledType(final Led.LedType LED_TYPE) {
    ...
    public final B peakValueVisible(final boolean PEAK_VALUE_VISIBLE) {
        properties.put("peakValueVisible", new SimpleBooleanProperty(PEAK_VALUE_VISIBLE));
        return(B) this;
    }

    public final B ledSize(final double LED_SIZE) {
        properties.put("ledSize", new SimpleDoubleProperty(LED_SIZE));
        return (B)this;
    }

    public final B ledColors(final Color... LED_COLORS) {
        properties.put("ledColorsArray", new SimpleObjectProperty<>(LED_COLORS));
        return (B)this;
    }
    
    public final B ledColors(final LinkedList<Color> LED_COLORS) {

...
class MenuSystem():
    ...
    def HandleSaveAsCSV(self):
        Interval = tkinter.simpledialog.askinteger("Interval","What time interval rate (seconds) to save data at? Zero will save all datapoints.",parent=self.root,minvalue=0,initialvalue=1)
        if None == Interval:
            return
